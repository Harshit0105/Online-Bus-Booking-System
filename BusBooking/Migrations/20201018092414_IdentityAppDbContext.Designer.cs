...
namespace BusBooking.Migrations
{
    ...
    [Migration("20201018092414_IdentityAppDbContext")]
    partial class IdentityAppDbContext
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusBooking.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BusBooking.Models.Bus", b =>
                {
                    ...
                    b.Property<DateTime>("Destination_Time")
                    ...
                    b.Property<DateTime>("Source_Time")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("BusBooking.Models.Seat", b =>
                {
            ...
            modelBuilder.Entity("BusBooking.Models.Ticket", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BusBooking.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
